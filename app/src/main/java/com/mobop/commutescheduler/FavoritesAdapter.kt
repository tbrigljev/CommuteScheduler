...
class FavoritesAdapter(
    ...
    override fun onBindViewHolder(
        ...
        holder.editFavorite(favoritesItemsList.indexOf(favoritesItemsList[position]), 1)
        holder.deleteFavorite(favoritesItemsList.indexOf(favoritesItemsList[position]), 3)
    }
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val favoritesButtons : ConstraintLayout =
            view.findViewById(R.id.favorites_buttons) as  ConstraintLayout

        val editButton =
            view.findViewById(R.id.favorite_edit) as ImageButton
        val deleteButton =
            view.findViewById(R.id.favorite_delete) as ImageButton
                        ...
                        if (previousPosition != getAdapterPosition()) {
                            try {
                                ...
                                val layoutButtons_previous: ConstraintLayout =
                                    view_previous!!.findViewById(R.id.favorites_buttons) as ConstraintLayout
